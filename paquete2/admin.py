from paquete2.models import Cliente, Payment, AgregarGasto, AgregarBase
...
#CAMBIAR TITULO DEL PANEL DE ADMINISTRACION DE Django
admin.site.site_header="PANEL DE ADMINISTRACION "
admin.site.index_title=" Paquetes Turquesa "#ESTE ES EL TITULO QUE VA DESPUES DEL HEADER Y TAMBIEN SE MUESTRA EN EL TITULO DEL NAVEGADOR
admin.site.site_title="Administracion" #ESTE ES EL SEGUNDO TITULO QUE SALE EN EL NAVEGADOR
